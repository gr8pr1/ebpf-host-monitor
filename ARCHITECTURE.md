...
| OTel exporter package | `internal/otelexport/` | Planned |
| OTel config section | `internal/config/` | Planned |
| OTel wiring in main.go | `cmd/agent/main.go` | Planned |
| MAD scorer (alternative to z-score) | `internal/scorer/` | Planned |
| MITRE temporal kill chain correlation | `internal/mitre/` | Planned |
| BPF program test harness | `bpf/` | Planned |
